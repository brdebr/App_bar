...
import brdebr.bryan.app_bar.Activities.Lista_platos_seleccionables;
import brdebr.bryan.app_bar.Adaptadores.Adaptador_lista_Plato;
import brdebr.bryan.app_bar.Adaptadores.Adaptador_lista_Plato_seleccionables;
...
public class Fragment_lista_platos_seleccionables extends Fragment implements RecyclerViewClickListener{


    /**
     * Adaptador del recycler view del fragmento "Lista platos"
     */
    private Adaptador_lista_Plato_seleccionables adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_lista_platos_seleccionables, container, false);

        // Coger la referencia del recicler view y poner su tamaño fijo
        lista = (RecyclerView) v.findViewById(R.id.recycler_lista_seleccionable);
        lista.setAdapter(new Adaptador_lista_Plato_seleccionables());
        ...
        cargarAdaptador_seleccionables();
     ...
     * en la respuesta
     */
    public void cargarAdaptador_seleccionables() {
        // Petición POST
        VolleySingleton.
                ...
                addToRequestQueue(
                        new JsonObjectRequest(
                                Request.Method.POST,
                                "http://"+ Datos_conexion.getDireccionIP()+"/app_bar/obtener_platos_seleccionables.php",
        ...
        try {
            ...
            switch (estado) {
                case "1": // EXITO
                    ...
                    // Parsear con Gson
                    Plato_seleccionable[] platos = gson.fromJson(mensaje.toString(), Plato_seleccionable[].class);
                    // Inicializar adaptador
                    adapter = new Adaptador_lista_Plato_seleccionables(Arrays.asList(platos), getActivity(),this);
    ...
    public void recyclerViewListClicked(View v, int position) {
        ...
        Lista_platos_seleccionables aux = ((Lista_platos_seleccionables) getActivity());

        //((View) v.getParent()).findViewById(R.id.edit_txt_cantidad_plato_seleccionable);
        EditText aux_view = ((EditText) ((View) v.getParent()).findViewById(R.id.edit_txt_cantidad_plato_seleccionable));
        //EditText aux_view = ((EditText) v.findViewById(R.id.edit_txt_cantidad_plato_seleccionable));

        aux.anadir_seleccionado(adapter.getItems().get(position),Integer.parseInt(aux_view.getText().toString()));
        aux_view.setText("");
    }
}
